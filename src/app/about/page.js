                    ...
                    <div className="project-module mt-8 flex flex-row">
                        ...
                        <div className="w-3/4 break-word flex flex-col texteditor-inline">
                            ...
                            <div className="w-full span">
                                <span className="w-full mt-2"><strong>M.E (Applied Electronics)</strong></span><br />
                                <span className="w-full mt-2">Jerusalem College of Engineering | Chennai, Tamil Nadu, India</span><br />
                                <span className="w-full mt-2">2022 - 2024</span><br />
                            </div>
                            <div className="w-full span">
                                <span className="w-full mt-5"><strong>B.E (ECE)</strong></span><br />
                                <span className="w-full mt-2">Sri Sai Ram Institute of Technology | Chennai, Tamil Nadu, India</span><br />
                                <span className="w-full mt-2">2014 - 2018</span><br />
                            </div>
                            <div className="float-left sub-title flex flex-row"><Image
                                ...
                                width='35'
                                height='35'
                            /><a className="ml-3" target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1FUhDazPGG-J-rZnK5y0kz3iDMkEIlIlz/view?usp=sharing"><u>Resume</u></a></div></div>
                    </div>
                </div>
            </div>
            <BackToTop />
