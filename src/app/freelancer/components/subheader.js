        ...
        <>
            <div className="w-full pl-8 flex flex-row">
                ...
                <div className="w-full content-center text-right back-btn"><ul className="sub-heading title preserve-whitespace e2e-site-logo-text flex flex-row">
                    <li>
                        <Link href="/freelancer/projects" className={`btn link ${pathname === '/' ? 'active' : ''}`}>Back To Projects</Link>
                    </li>
                    <li>
                        <Link href="/freelancer" className={`btn link ${pathname === '/' ? 'active' : ''}`}>Main Page</Link>
                    </li>
                </ul></div>
            </div>
