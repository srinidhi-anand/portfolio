export const works = {
  "Intelligent Testing Framework": {
    stack: "Node.js + PNPM + Typescript + Gen AI + Jest",
    text: "AI-powered Jest test case generator. Implemented CI/CD pipelines with GitHub Actions for auto deployment and package releases. Designed to integrate smoothly into modern backend workflows and supports multiple LLM providers (Gemini, OpenAI, Groq) with a reliable retry mechanism to handle transient AI failures",
    url: "npm_",
    extension: ["png", "png"],
    image_count: 2,
  },
  ...
  "Razor Blade": {
    stack:
      "Javascript + IPython + Postman + Swagger + MSSQL + SAP CPQ + SAP CRM + GitHub + JIRA.",
